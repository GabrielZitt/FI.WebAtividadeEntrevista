...
namespace FI.AtividadeEntrevista.DAL
{
    ...
    internal class DaoCliente : AcessoDados
    {
        ...
        internal long IncluirB(DML.Beneficiario beneficiario)
        {
            List<System.Data.SqlClient.SqlParameter> parametrosB = new List<System.Data.SqlClient.SqlParameter>();
            parametrosB.Add(new System.Data.SqlClient.SqlParameter("Nome", beneficiario.Nome));
            parametrosB.Add(new System.Data.SqlClient.SqlParameter("CPF", beneficiario.CPF));
            parametrosB.Add(new System.Data.SqlClient.SqlParameter("IDCLIENTE", beneficiario.IdCliente));
            DataSet ds = base.Consultar("FI_SP_IncBeneficiario", parametrosB);
            long ret = 0;
            if (ds.Tables[0].Rows.Count > 0)
                long.TryParse(ds.Tables[0].Rows[0][0].ToString(), out ret);
            return ret;
        ...
        //internal DML.Beneficiario Consultarb(long IDCLIENTE)
        //{
        //    List<System.Data.SqlClient.SqlParameter> parametrosb = new List<System.Data.SqlClient.SqlParameter>();

        //    parametrosb.Add(new System.Data.SqlClient.SqlParameter("IDCLIENTE", IDCLIENTE));

        //    DataSet ds = base.Consultar("FI_SP_ConsBeneficiario", parametrosb);
        ...
        //        {
        //            IdCliente = (int)Convert.ToInt64(row["IDCLIENTE"]),
        ...
        internal void AlterarB(DML.Beneficiario beneficiario)
        {
            List<System.Data.SqlClient.SqlParameter> parametrosB = new List<System.Data.SqlClient.SqlParameter>();
            parametrosB.Add(new System.Data.SqlClient.SqlParameter("Nome", beneficiario.Nome));
            parametrosB.Add(new System.Data.SqlClient.SqlParameter("CPF", beneficiario.CPF));
            ...
            base.Executar("FI_SP_AltBeneficiario", parametrosB);
        }
